# Owner Portal · Home — pixel build prompt
...
## Source of truth
- **Mockup (pixel target):** `cabinets/owner-p1/01-home.html`
...
**Repo status:** ✅ `/owner` `page.tsx` 15.9kb. Redesign — owners visit 2–4×/month, lead with narrative clarity.
...
`.kpi-narrative` (Newsreader 44px) hero KPIs · portfolio-at-a-glance cards · upcoming statement nudge.

## Gotchas
- Owner = calm. Bigger type, more whitespace, fewer ops controls than Mgmt.
