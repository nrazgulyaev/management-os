# Management OS · Documents — pixel build prompt
...
## Source of truth
- **Mockup (pixel target):** `cabinets/new/mgmt-documents.html`
...
**Repo status:** ✅ `/dashboard/documents` built. Redesign.
...
Doc rows/groups + bundle action; reuse owner `DocRow`/`DocGroup` pattern if shared.
