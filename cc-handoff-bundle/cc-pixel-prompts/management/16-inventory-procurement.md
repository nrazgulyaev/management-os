# Management OS · Inventory & Procurement — pixel build prompt
...
## Source of truth
- **Mockup (pixel target):** `cabinets/new/mgmt-inventory-procurement.html`
...
**Repo status:** ✅ `/dashboard/inventory` + `/dashboard/procurement` built. Redesign.
...
Stock table + procurement requests list.

## Gotchas
- 2 routes in one mockup.
