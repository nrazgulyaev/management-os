# Development OS · Knowledge & Docs (cluster) — pixel build prompt
...
## Source of truth
- **Mockup (pixel target):** `cabinets/dev-p3/Dev Knowledge and Docs.html`
...
Drawing/file rows + method-statement docs + materials catalog.
