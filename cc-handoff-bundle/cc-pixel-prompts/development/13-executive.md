# Development OS · Dev Executive — pixel build prompt
...
## Source of truth
- **Mockup (pixel target):** `cabinets/new/dev-executive.html`
...
**Repo status:** ✅ `/development-os/dashboard` (executive). Redesign.
...
Portfolio roll-up KPIs + risk overview + `WaterfallChart` summary.

## Gotchas
- Portfolio-level view — aggregate across projects.
