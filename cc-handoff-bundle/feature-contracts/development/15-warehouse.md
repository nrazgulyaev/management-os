# FC-DEVELOPMENT-WAREHOUSE — Dev warehouse / materials

> Behavior contract. Read `00-MASTER-CONTRACT.md` first. Pair with pixel prompt `cc-pixel-prompts/development/15-warehouse.md` (look) and the cabinet's migration (storage).
...
- pixel: `cc-pixel-prompts/development/15-warehouse.md` + its mockup HTML in `cabinets/`
...
| | |
|---|---|
| **Primary surface** | Dev warehouse / materials — `/development-os/materials` |
| **Pixel truth** | `cc-pixel-prompts/development/15-warehouse.md` |
| **Cross-surface partners** | — (single-surface cabinet) |
| **Tables** | `materials` · `assets` · `asset_types` |

## Function inventory

| # | Function | What it does | Tags | Status |
|---|---|---|---|---|
| 1 | Warehouse / materials store | /materials + assets/asset-types | [core] | Have/verify |
| 2 | Bulk import | /bulk-import CSV ingest |  | Have/verify |
