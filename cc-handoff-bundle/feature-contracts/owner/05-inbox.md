# FC-OWNER-INBOX — Owner Inbox

> Behavior contract. Read `00-MASTER-CONTRACT.md` first. Pair with pixel prompt `cc-pixel-prompts/owner/05-inbox.md` (look) and the cabinet's migration (storage).
...
- pixel: `cc-pixel-prompts/owner/05-inbox.md` + its mockup HTML in `cabinets/`
...
| | |
|---|---|
| **Primary surface** | Owner Inbox — `/owner/inbox` |
| **Pixel truth** | `cc-pixel-prompts/owner/05-inbox.md` |
| **Cross-surface partners** | — (single-surface cabinet) |
| **Tables** | `owner_threads` · `owner_messages` |

## Function inventory

| # | Function | What it does | Tags | Status |
|---|---|---|---|---|
| 1 | Thread list | owner_threads (0114) | [core] | Have/verify |
| 2 | Thread view + messages | owner_messages |  | Have/verify |
| 3 | Owner-concierge agent | formal investor-tone replies | [ai] | Build/verify |
| 4 | Compose / reply | message bubble + composer |  | Have/verify |
