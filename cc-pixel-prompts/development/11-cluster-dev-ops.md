# Development OS · Dev Ops (cluster) — pixel build prompt
...
## Source of truth
- **Mockup (pixel target):** `cabinets/dev-p3/Dev Ops.html`
...
Marketing leads + inbox threads + cycle board + productivity metrics.
