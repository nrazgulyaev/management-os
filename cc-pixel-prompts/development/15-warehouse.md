# Development OS · Dev Warehouse — pixel build prompt
...
## Source of truth
- **Mockup (pixel target):** `cabinets/new/dev-warehouse.html`
...
**Repo status:** ✅ `/development-os/materials` + assets + inventory built. Redesign.
...
Materials store table + asset catalog + stock levels.

## Gotchas
- Multiple routes in one mockup.
