# Development OS · Dev Marketing — pixel build prompt
...
## Source of truth
- **Mockup (pixel target):** `cabinets/new/dev-marketing.html`
...
- `/development-os/marketing`

**Repo status:** ✅ `/development-os/marketing` built. Redesign.
...
Leads list + campaign cards + `FunnelChart`.
