# Owner Portal · Documents — pixel build prompt
...
## Source of truth
- **Mockup (pixel target):** `cabinets/owner-p1/06-documents.html`
...
**Repo status:** ✅ `/owner/documents`. Redesign.
...
`DocRow` + `DocGroup` + bundle generation (PDF stitcher).

## Gotchas
- Bundle PDF stitcher is a deferred backend item — design the UI, flag the wiring.
