# Management OS · Dynamic pricing — pixel build prompt
...
## Source of truth
- **Mockup (pixel target):** `cabinets/mgmt-p2/dynamic-pricing.html`
...
- `/dashboard/pricing/quote`
- `/dashboard/pricing/rule-sets`
- `/dashboard/pricing/rule-sets/[id]`
- `/dashboard/pricing/rule-sets/new`

**Repo status:** ✅ built deep — `/dashboard/pricing` 8 pages. Redesign.
...
**`PricingCurve`** (2.4 primitive) for the price curve · `RuleRow`/`RuleEditor`/`CompTable` · priority rule evaluator output shown inline.

## Gotchas
- Verify pricing-rule schema vs drizzle 0036 before wiring.
- Comp similarity scoring is a pure fn — show its output, do not recompute in UI.
...
- [ ] PricingCurve matches mockup axis/scale
