# Management OS · Utilities — pixel build prompt
...
## Source of truth
- **Mockup (pixel target):** `cabinets/new/mgmt-utilities.html`
...
**Repo status:** ✅ `/dashboard/utilities` 7 pages (accounts/readings/payments/risks). Redesign.
...
Accounts list + readings table + payment rows.
