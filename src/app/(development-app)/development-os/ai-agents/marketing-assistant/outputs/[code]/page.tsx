...
export const metadata: Metadata = { title: "Marketing Assistant output · AI agents" };
    ...
    <DevelopmentShell>
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: "Marketing Assistant", href: "/development-os/ai-agents/marketing-assistant" },
      ...
      <AgentOutputDetail
        ...
        backHref="/development-os/ai-agents/marketing-assistant"
      />
    </DevelopmentShell>
  );
}
