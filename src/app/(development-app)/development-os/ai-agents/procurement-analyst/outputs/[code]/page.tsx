...
export const metadata: Metadata = { title: "Procurement Analyst output · AI agents" };
    ...
    <DevelopmentShell>
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: "Procurement Analyst", href: "/development-os/ai-agents/procurement-analyst" },
      ...
      <AgentOutputDetail
        ...
        backHref="/development-os/ai-agents/procurement-analyst"
      />
    </DevelopmentShell>
  );
}
