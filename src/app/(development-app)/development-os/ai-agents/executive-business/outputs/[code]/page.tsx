...
export const metadata: Metadata = { title: "Executive Business Analyst output · AI agents" };
    ...
    <DevelopmentShell>
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: "Executive Business Analyst", href: "/development-os/ai-agents/executive-business" },
      ...
      <AgentOutputDetail
        ...
        backHref="/development-os/ai-agents/executive-business"
      />
    </DevelopmentShell>
  );
}
