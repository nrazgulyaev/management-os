  ...
  return (
    <div className="max-w-[1400px] mx-auto px-6 md:px-8 py-10 flex flex-col gap-8">
      <PageHeader
        ...
        title="Plans & pricing"
        description="The plan catalog that gates customers by tier. Set price (minor units), trial length, limits, and visibility. No charge is made here — pricing flows to subscriptions via org_subscriptions."
      />
