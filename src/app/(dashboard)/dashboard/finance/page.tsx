      ...
      <div className="page-header mb-0">
        <div className="left">
          ...
          <h1>
            {detail ? (
              <>
                {detail.ownerName} · <em>{detail.villaCode ?? "—"}</em> · {detail.monthLabel}
              </>
            ) : (
              "Owner statements"
            )}
          ...
          <p className="text-[13px] text-ink-3 mt-2 max-w-[680px]">
            {detail
              ? "Real statement generated by the engine. Approve to allow sending; mark sent after delivering the PDF."
        ...
        <div className="actions flex gap-2 items-center">
          <Link href="/dashboard/finance/statement-settings" className="btn btn-secondary btn-sm">
            Statement settings
          </Link>
