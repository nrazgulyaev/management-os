...
/**
 * Sprint ARCH-1 — placeholder landing for development.arconique.com.
 *
 * The middleware rewrites `/` on the development subdomain to this
...
export const metadata = {
  ...
  description:
    "Real-estate development command center — projects, finance, procurement, investors.",
};
    ...
    <main className="min-h-screen flex items-center justify-center bg-bg px-6 py-16">
      <div className="max-w-2xl text-center flex flex-col gap-7">
        ...
        <h1 className="font-display text-[44px] md:text-[60px] leading-[1.05] text-ink-deep">
          Development <span className="italic text-terra">OS</span>
        </h1>
        <p className="text-ink-2 text-[17px] leading-[1.55]">
          Command center for real-estate development — projects,
          cashflow, procurement, investor reporting. The full landing
