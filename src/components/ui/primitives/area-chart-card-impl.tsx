/**
 * Sprint 1 — AreaChartCard recharts implementation.
 *
 * Split out of `area-chart-card.tsx` so recharts loads lazily (the public
 * `AreaChartCard` is a `next/dynamic({ ssr:false })` wrapper around this
 * module). Behaviour is identical to the original component.
 */
...
export function AreaChartCardImpl({
  title,
  period,
  data,
  tone = "emerald",
