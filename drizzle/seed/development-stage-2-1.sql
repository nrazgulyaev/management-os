...
VALUES
  ('1eda0001-0000-0000-0000-000000000001', 'leasehold', 30, '2024-09-01', '2054-09-01',
    8400.00, 6800.00, 5400.00, '2024-09-15', '2026-09-30', 'USD', 'IDR',
    'Hybrid ownership: 6 sold individual + pooled rental fund.'),
  ('1eda0001-0000-0000-0000-000000000002', 'leasehold', 30, '2025-04-01', '2055-04-01',
    11200.00, 9100.00, 7400.00, '2025-04-10', '2027-04-30', 'USD', 'IDR',
    'Pooled-only model.'),
  ('1eda0001-0000-0000-0000-000000000003', 'joint_venture', NULL, NULL, NULL,
...
VALUES
  -- Eternal Villas
  ('22222222-2222-4222-8222-100000000001', '1eda0001-0000-0000-0000-000000000001', 'land_sourcing',      'completed',   '2024-06-01','2024-06-15','2024-09-01','2024-09-15', NULL),
  ('22222222-2222-4222-8222-100000000002', '1eda0001-0000-0000-0000-000000000001', 'due_diligence',      'completed',   '2024-07-01','2024-07-10','2024-09-01','2024-09-05', NULL),
  ('22222222-2222-4222-8222-100000000003', '1eda0001-0000-0000-0000-000000000001', 'design',             'completed',   '2024-09-15','2024-09-20','2025-02-01','2025-02-10', 'IBUKU lead architect'),
  ('22222222-2222-4222-8222-100000000004', '1eda0001-0000-0000-0000-000000000001', 'permits',            'completed',   '2025-01-15','2025-01-20','2025-03-15','2025-03-22', NULL),
  ('22222222-2222-4222-8222-100000000005', '1eda0001-0000-0000-0000-000000000001', 'pre_sales',          'in_progress', '2025-03-01','2025-03-12','2026-08-31', NULL,         '6 of 8 reserved'),
  ('22222222-2222-4222-8222-100000000006', '1eda0001-0000-0000-0000-000000000001', 'under_construction', 'in_progress', '2025-04-01','2025-04-08','2026-09-15', NULL,         '64% cost-loaded progress'),

  -- Enso Villas
  ('22222222-2222-4222-8222-100000000010', '1eda0001-0000-0000-0000-000000000002', 'land_sourcing',      'completed',   '2024-12-01','2024-12-10','2025-04-01','2025-04-08', NULL),
  ('22222222-2222-4222-8222-100000000011', '1eda0001-0000-0000-0000-000000000002', 'due_diligence',      'completed',   '2025-01-01','2025-01-15','2025-03-15','2025-03-20', NULL),
  ('22222222-2222-4222-8222-100000000012', '1eda0001-0000-0000-0000-000000000002', 'design',             'completed',   '2025-04-15','2025-04-20','2025-08-15','2025-08-22', NULL),
  ('22222222-2222-4222-8222-100000000013', '1eda0001-0000-0000-0000-000000000002', 'permits',            'completed',   '2025-08-01','2025-08-10','2025-09-15','2025-09-18', NULL),
  ('22222222-2222-4222-8222-100000000014', '1eda0001-0000-0000-0000-000000000002', 'pre_sales',          'in_progress', '2025-09-01','2025-09-15','2027-04-15', NULL,         '2 of 9 reserved'),
  ('22222222-2222-4222-8222-100000000015', '1eda0001-0000-0000-0000-000000000002', 'under_construction', 'in_progress', '2025-09-15','2025-09-22','2027-04-15', NULL,         '22% progress, 8 days ahead'),

  -- Ahau Gardens
  ('22222222-2222-4222-8222-100000000020', '1eda0001-0000-0000-0000-000000000003', 'land_sourcing',      'completed',   '2025-08-01','2025-08-15','2025-11-15','2025-11-20', NULL),
  ('22222222-2222-4222-8222-100000000021', '1eda0001-0000-0000-0000-000000000003', 'due_diligence',      'completed',   '2025-09-15','2025-10-01','2025-12-01','2025-12-08', NULL),
  ('22222222-2222-4222-8222-100000000022', '1eda0001-0000-0000-0000-000000000003', 'design',             'completed',   '2025-12-01','2025-12-10','2026-03-15','2026-03-20', NULL),
  ('22222222-2222-4222-8222-100000000023', '1eda0001-0000-0000-0000-000000000003', 'permits',            'in_progress', '2026-02-01','2026-02-12','2026-04-15', NULL,         'PBG rejected on setback definition; redesign of north edge')
...
VALUES
  ('1eda0001-0000-0000-0000-000000000001', 'EV-PLOT-01', 'leasehold', 'Pak Wayan Subagia',
  ...
  ('1eda0001-0000-0000-0000-000000000002', 'ES-PLOT-01', 'leasehold', 'Putu Astawa',
  ...
  ('1eda0001-0000-0000-0000-000000000003', 'AH-PLOT-01', 'joint_venture', 'Made Sudarsana family',
...
VALUES
  ('1eda0001-0000-0000-0000-000000000001', 'Type L',
  ...
  ('1eda0001-0000-0000-0000-000000000001', 'Type Q',
  ...
  ('1eda0001-0000-0000-0000-000000000002', 'Type V',
  ...
  ('1eda0001-0000-0000-0000-000000000003', 'Type R',
...
VALUES
  ('33333333-3333-4333-8333-100000000001', '1eda0001-0000-0000-0000-000000000001', 'eternal-01', 'EV-01', 'Eternal Villa 01', 'ready', 3),
  ('33333333-3333-4333-8333-100000000002', '1eda0001-0000-0000-0000-000000000001', 'eternal-02', 'EV-02', 'Eternal Villa 02', 'ready', 3),
  ('33333333-3333-4333-8333-100000000003', '1eda0001-0000-0000-0000-000000000001', 'eternal-03', 'EV-03', 'Eternal Villa 03', 'ready', 3),
  ('33333333-3333-4333-8333-100000000004', '1eda0001-0000-0000-0000-000000000001', 'eternal-04', 'EV-04', 'Eternal Villa 04', 'ready', 4),
  ('33333333-3333-4333-8333-100000000005', '1eda0001-0000-0000-0000-000000000001', 'eternal-05', 'EV-05', 'Eternal Villa 05', 'ready', 4),
  ('33333333-3333-4333-8333-100000000006', '1eda0001-0000-0000-0000-000000000001', 'eternal-06', 'EV-06', 'Eternal Villa 06', 'ready', 3),
  ('33333333-3333-4333-8333-100000000007', '1eda0001-0000-0000-0000-000000000001', 'eternal-07', 'EV-07', 'Eternal Villa 07', 'ready', 3),
  ('33333333-3333-4333-8333-100000000008', '1eda0001-0000-0000-0000-000000000001', 'eternal-08', 'EV-08', 'Eternal Villa 08', 'ready', 4),
  -- Enso: 9 villas
  ('33333333-3333-4333-8333-200000000001', '1eda0001-0000-0000-0000-000000000002', 'enso-01', 'ES-01', 'Enso Villa 01', 'ready', 3),
  ('33333333-3333-4333-8333-200000000002', '1eda0001-0000-0000-0000-000000000002', 'enso-02', 'ES-02', 'Enso Villa 02', 'ready', 3),
  ('33333333-3333-4333-8333-200000000003', '1eda0001-0000-0000-0000-000000000002', 'enso-03', 'ES-03', 'Enso Villa 03', 'ready', 3),
  ('33333333-3333-4333-8333-200000000004', '1eda0001-0000-0000-0000-000000000002', 'enso-04', 'ES-04', 'Enso Villa 04', 'ready', 3),
  ('33333333-3333-4333-8333-200000000005', '1eda0001-0000-0000-0000-000000000002', 'enso-05', 'ES-05', 'Enso Villa 05', 'ready', 3),
  ('33333333-3333-4333-8333-200000000006', '1eda0001-0000-0000-0000-000000000002', 'enso-06', 'ES-06', 'Enso Villa 06', 'ready', 3),
  ('33333333-3333-4333-8333-200000000007', '1eda0001-0000-0000-0000-000000000002', 'enso-07', 'ES-07', 'Enso Villa 07', 'ready', 3),
  ('33333333-3333-4333-8333-200000000008', '1eda0001-0000-0000-0000-000000000002', 'enso-08', 'ES-08', 'Enso Villa 08', 'ready', 3),
  ('33333333-3333-4333-8333-200000000009', '1eda0001-0000-0000-0000-000000000002', 'enso-09', 'ES-09', 'Enso Villa 09', 'ready', 3),
  -- Ahau: 12 villas
  ('33333333-3333-4333-8333-300000000001', '1eda0001-0000-0000-0000-000000000003', 'ahau-01', 'AH-01', 'Ahau Villa 01', 'ready', 2),
  ('33333333-3333-4333-8333-300000000002', '1eda0001-0000-0000-0000-000000000003', 'ahau-02', 'AH-02', 'Ahau Villa 02', 'ready', 2),
  ('33333333-3333-4333-8333-300000000003', '1eda0001-0000-0000-0000-000000000003', 'ahau-03', 'AH-03', 'Ahau Villa 03', 'ready', 2),
  ('33333333-3333-4333-8333-300000000004', '1eda0001-0000-0000-0000-000000000003', 'ahau-04', 'AH-04', 'Ahau Villa 04', 'ready', 2),
  ('33333333-3333-4333-8333-300000000005', '1eda0001-0000-0000-0000-000000000003', 'ahau-05', 'AH-05', 'Ahau Villa 05', 'ready', 2),
  ('33333333-3333-4333-8333-300000000006', '1eda0001-0000-0000-0000-000000000003', 'ahau-06', 'AH-06', 'Ahau Villa 06', 'ready', 2),
  ('33333333-3333-4333-8333-300000000007', '1eda0001-0000-0000-0000-000000000003', 'ahau-07', 'AH-07', 'Ahau Villa 07', 'ready', 2),
  ('33333333-3333-4333-8333-300000000008', '1eda0001-0000-0000-0000-000000000003', 'ahau-08', 'AH-08', 'Ahau Villa 08', 'ready', 2),
  ('33333333-3333-4333-8333-300000000009', '1eda0001-0000-0000-0000-000000000003', 'ahau-09', 'AH-09', 'Ahau Villa 09', 'ready', 2),
  ('33333333-3333-4333-8333-300000000010', '1eda0001-0000-0000-0000-000000000003', 'ahau-10', 'AH-10', 'Ahau Villa 10', 'ready', 2),
  ('33333333-3333-4333-8333-300000000011', '1eda0001-0000-0000-0000-000000000003', 'ahau-11', 'AH-11', 'Ahau Villa 11', 'ready', 2),
  ('33333333-3333-4333-8333-300000000012', '1eda0001-0000-0000-0000-000000000003', 'ahau-12', 'AH-12', 'Ahau Villa 12', 'ready', 2)
ON CONFLICT (id) DO UPDATE SET
