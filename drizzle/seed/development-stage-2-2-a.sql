...
VALUES
  ...
  ('eeeeeeee-0000-4000-8000-000000000001',
    ...
    '1eda0001-0000-0000-0000-000000000001', 'new',                '2026-04-28 09:00+00',
    'cccccccc-0000-4000-8000-000000000002', NULL,
    (SELECT id FROM unit_types WHERE name = 'Type Q' AND project_id = '1eda0001-0000-0000-0000-000000000001' LIMIT 1),
    NULL),
  ('eeeeeeee-0000-4000-8000-000000000002',
    'dddddddd-0000-4000-8000-000000000007', 'lead', 'project',
    '1eda0001-0000-0000-0000-000000000003', 'new',                '2026-04-29 14:20+00',
  ...
  ('eeeeeeee-0000-4000-8000-000000000003',
    ...
    '1eda0001-0000-0000-0000-000000000001', 'contacted',          '2026-04-22 10:00+00',
    'cccccccc-0000-4000-8000-000000000001', NULL,
    (SELECT id FROM unit_types WHERE name = 'Type L' AND project_id = '1eda0001-0000-0000-0000-000000000001' LIMIT 1),
    NULL),
  ('eeeeeeee-0000-4000-8000-000000000004',
    'dddddddd-0000-4000-8000-000000000004', 'lead', 'project',
    '1eda0001-0000-0000-0000-000000000002', 'contacted',          '2026-04-25 16:30+00',
  ...
  ('eeeeeeee-0000-4000-8000-000000000005',
    ...
    '1eda0001-0000-0000-0000-000000000001', 'qualified',          '2026-04-15 11:00+00',
  ...
  ('eeeeeeee-0000-4000-8000-000000000006',
    ...
    '1eda0001-0000-0000-0000-000000000001', 'qualified',          '2026-04-18 09:30+00',
  ...
  ('eeeeeeee-0000-4000-8000-000000000007',
    ...
    '1eda0001-0000-0000-0000-000000000002', 'viewing_scheduled',  '2026-04-10 15:45+00',
    'cccccccc-0000-4000-8000-000000000001', NULL,
    (SELECT id FROM unit_types WHERE name = 'Type V' AND project_id = '1eda0001-0000-0000-0000-000000000002' LIMIT 1),
    'Site visit booked 2026-05-12.'),

  -- negotiation
  ('eeeeeeee-0000-4000-8000-000000000008',
    'dddddddd-0000-4000-8000-000000000009', 'lead', 'project',
    '1eda0001-0000-0000-0000-000000000001', 'negotiation',        '2026-03-22 11:00+00',
    'cccccccc-0000-4000-8000-000000000003',
    'bbbbbbbb-0000-4000-8000-000000000001',
    (SELECT id FROM unit_types WHERE name = 'Type Q' AND project_id = '1eda0001-0000-0000-0000-000000000001' LIMIT 1),
  ...
  ('eeeeeeee-0000-4000-8000-000000000009',
    ...
    '1eda0001-0000-0000-0000-000000000002', 'reservation',        '2026-03-12 09:00+00',
    'cccccccc-0000-4000-8000-000000000001', NULL,
    (SELECT id FROM unit_types WHERE name = 'Type V' AND project_id = '1eda0001-0000-0000-0000-000000000002' LIMIT 1),
  ...
  ('eeeeeeee-0000-4000-8000-000000000010',
    ...
    '1eda0001-0000-0000-0000-000000000003', 'lost',               '2026-03-01 13:00+00',
...
VALUES
  ('ffffffff-0000-4000-8000-000000000001',
    'dddddddd-0000-4000-8000-000000000001', '1eda0001-0000-0000-0000-000000000001',
  ...
  ('ffffffff-0000-4000-8000-000000000003',
    'dddddddd-0000-4000-8000-000000000002', '1eda0001-0000-0000-0000-000000000001',
  ...
  ('ffffffff-0000-4000-8000-000000000005',
    'dddddddd-0000-4000-8000-000000000003', '1eda0001-0000-0000-0000-000000000001',
  ...
  ('ffffffff-0000-4000-8000-000000000007',
    'dddddddd-0000-4000-8000-000000000006', '1eda0001-0000-0000-0000-000000000002',
  ...
  ('ffffffff-0000-4000-8000-000000000008',
    'dddddddd-0000-4000-8000-000000000009', '1eda0001-0000-0000-0000-000000000001',
  ...
  ('ffffffff-0000-4000-8000-000000000009',
    'dddddddd-0000-4000-8000-000000000008', '1eda0001-0000-0000-0000-000000000002',
  ...
  ('ffffffff-0000-4000-8000-000000000010',
    'dddddddd-0000-4000-8000-000000000010', '1eda0001-0000-0000-0000-000000000003',
